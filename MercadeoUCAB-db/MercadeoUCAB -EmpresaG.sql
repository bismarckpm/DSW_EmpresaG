...
-- -----------------------------------------------------
-- Table `empresag`.`GRUPO_FAMILIAR`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `empresag`.`GRUPO_FAMILIAR` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `empresag`.`PERSONA_DISPONIBILIDAD`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `empresag`.`PERSONA_DISPONIBILIDAD` (
  `fk_persona` INT NOT NULL,
  `fk_disponibilidad` INT NOT NULL,
  PRIMARY KEY (`fk_persona`, `fk_disponibilidad`),
  INDEX `fk_perdisponib_disponibilidad_idx` (`fk_disponibilidad` ASC) VISIBLE,
  CONSTRAINT `fk_perdisponib_persona`
    FOREIGN KEY (`fk_persona`)
    REFERENCES `empresag`.`PERSONA` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_perdisponib_disponibilidad`
...
CREATE TABLE IF NOT EXISTS `empresag`.`PERSONA_DISPOSITIVO` (
  ...
  PRIMARY KEY (`fk_persona`, `fk_dispositivo`),
...
CREATE TABLE IF NOT EXISTS `empresag`.`PERSONA_OCUPACION` (
  ...
  PRIMARY KEY (`fk_persona`, `fk_ocupacion`),
...
CREATE TABLE IF NOT EXISTS `empresag`.`PERSONA_NVLACADEMICO` (
  ...
  PRIMARY KEY (`fk_persona`, `fk_nivel_academico`),
...
-- -----------------------------------------------------
-- Table `empresag`.`PERSONA_GRUPOFAMILIAR`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `empresag`.`PERSONA_GRUPOFAMILIAR` (
  `fk_persona` INT NOT NULL,
  `fk_grupo_familiar` INT NOT NULL,
  PRIMARY KEY (`fk_persona`, `fk_grupo_familiar`),
  INDEX `fk_pergfam_grupofamiliar_idx` (`fk_grupo_familiar` ASC) VISIBLE,
  CONSTRAINT `fk_pergfam_persona`
    FOREIGN KEY (`fk_persona`)
    REFERENCES `empresag`.`PERSONA` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pergfam_grupofamiliar`
    FOREIGN KEY (`fk_grupo_familiar`)
    REFERENCES `empresag`.`GRUPO_FAMILIAR` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `empresag`.`FILTRO` (
  ...
  INDEX `fk_filtro_grupofamiliar_idx` (`fk_grupo_familiar` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_filtro_genero`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_filtro_grupofamiliar`
    FOREIGN KEY (`fk_grupo_familiar`)
    REFERENCES `empresag`.`GRUPO_FAMILIAR` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `empresag`.`CATEGORIA_SUBCATEGORIA` (
  ...
  PRIMARY KEY (`fk_categoria`, `fk_subcategoria`),
...
CREATE TABLE IF NOT EXISTS `empresag`.`SUBCATEGORIA_MARCA` (
  ...
  PRIMARY KEY (`fk_subcategoria`, `fk_marca`),
...
CREATE TABLE IF NOT EXISTS `empresag`.`TIPO_PRESENTACION` (
  ...
  PRIMARY KEY (`fk_tipo`, `fk_presentacion`),
