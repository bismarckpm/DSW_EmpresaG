...
public class SurveyService {
    ...
    @GET
    @Path("/available-population/{studyId}/{personId}")
    public Response isPersonPartOfAvailablePopulation(@PathParam("studyId") long studyId, @PathParam("personId") long personId){
        DaoEncuesta daoEncuesta = new DaoEncuesta();
        boolean isPartOfAvailablePopulation = daoEncuesta.isPersonPartOfAvailablePopulation(studyId, personId);
    ...
    @POST
    @Path("/take/{studyId}/{personId}")
    public Response takeSurvey(@PathParam("studyId") long studyId, @PathParam("personId") long personId,
